...
class ReportService
{
    ...
    public function exportPaymentCsv(Request $request): Response
    {
        ...
        $headers = ['ID', __('Vendor'), __('Invoice Number'), __('Amount (INR)'), __('Status'), __('Requested Date'), __('Notes')];
        $rows = [];
    ...
    public function exportVendorCsv(Request $request): Response
    {
        ...
        $headers = ['ID', __('Company Name'), __('Contact Person'), 'Email', __('Status'), __('Compliance Status'), __('Compliance Score'), __('Performance Score'), __('Registered On')];
        $rows = [];
    ...
    public function exportPerformanceCsv(Request $request): Response
    {
        ...
        $headers = ['Rank', __('Company Name'), __('Performance Score'), __('Compliance Score'), __('Status')];
        $rows = [];
        $rank = 1;
        foreach ($vendors as $vendor) {
    ...
    public function exportComplianceCsv(Request $request): Response
    {
        ...
        $headers = ['ID', __('Company Name'), __('Compliance Status'), __('Compliance Score'), __('Vendor Status'), __('Registered On')];
        $rows = [];
        foreach ($vendors as $vendor) {
