  ...
  return <div className="bg-(--color-bg-primary) border border-(--color-border-primary) rounded-2xl p-8 md:p-12 shadow-token-lg animate-fade-in">
            ...
            label: 'Public Limited'
                    ...
                    <div className="space-y-2">
                        ...
                        <input type="text" value={data.tax_id} onChange={e => setData('tax_id', e.target.value.toUpperCase())} className="w-full px-4 py-3 bg-(--color-bg-primary) border border-(--color-border-primary) rounded-lg text-sm focus:border-(--color-border-focus) focus:ring-2 focus:ring-(--color-brand-primary)/20 outline-none transition-all" placeholder={t('22AAAAA0000A1Z5')} />
                    </div>
                    ...
                    <div className="space-y-2">
                        ...
                        <input type="text" value={data.pan_number} onChange={e => setData('pan_number', e.target.value.toUpperCase())} className="w-full px-4 py-3 bg-(--color-bg-primary) border border-(--color-border-primary) rounded-lg text-sm focus:border-(--color-border-focus) focus:ring-2 focus:ring-(--color-brand-primary)/20 outline-none transition-all" placeholder={t('ABCDE1234F')} />
                    ...
                    <div className="space-y-2">
                        ...
                        <input type="tel" value={data.contact_phone} onChange={e => setData('contact_phone', e.target.value)} className="w-full px-4 py-3 bg-(--color-bg-primary) border border-(--color-border-primary) rounded-lg text-sm focus:border-(--color-border-focus) focus:ring-2 focus:ring-(--color-brand-primary)/20 outline-none transition-all" placeholder={t('+91 98765 43210')} />
