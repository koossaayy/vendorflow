            ...
            <form onSubmit={submit} className="space-y-8">
                <div className="grid md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-2">
                        ...
                        <input type="text" value={data.bank_ifsc} onChange={e => setData('bank_ifsc', e.target.value.toUpperCase())} className="w-full px-4 py-3 bg-(--color-bg-primary) border border-(--color-border-primary) rounded-lg text-sm focus:border-(--color-border-focus) focus:ring-2 focus:ring-(--color-brand-primary)/20 outline-none transition-all uppercase" placeholder={t('SBIN0001234')} />
